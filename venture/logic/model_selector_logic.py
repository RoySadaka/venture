...
def get_model_name_for_retrieval(metadata:Metadata, user_query:str, functions:List[object]) -> str:
    token_count =   metadata.token_counts.retrieval_system_count + \
                    tclo.count_tokens(user_query) + \
                    tclo.count_tokens(Config.EXTRA_ROLE) + \
